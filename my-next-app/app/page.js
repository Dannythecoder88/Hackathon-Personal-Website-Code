    ...
    <div className="min-h-screen bg-black">
      ...
      <section className="py-16 px-6 bg-black">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
          {[1, 2, 3].map((item) => (
            <div key={item} className="bg-gray-900 rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow border border-gray-800">
              <div className="h-48 bg-gray-200"></div>
              <div className="p-6">
                <h3 className="text-xl font-semibold mb-2 text-white">Project {item}</h3>
                <p className="text-gray-300 mb-4">A brief description of the project and what it does.</p>
                <div className="flex flex-wrap gap-2">
                  <span className="bg-blue-900 text-blue-100 text-xs px-2 py-1 rounded">React</span>
                  <span className="bg-green-900 text-green-100 text-xs px-2 py-1 rounded">Node.js</span>
                </div>
              </div>
            </div>
          ))}
      ...
      {/* Call to Action */}
      <section className="bg-gray-900 rounded-xl p-12 text-center my-16 mx-6 border border-gray-800">
        <h2 className="text-4xl font-extrabold mb-4 text-white">Have a project in mind?</h2>
